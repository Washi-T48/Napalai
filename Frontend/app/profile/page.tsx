            ...
            <div className='flex justify-center  bg-customLinear w-full min-h-screen pt-16 '>
                <div className='flex flex-col justify-center items-center w-3/5 h-full text-white  '>
                    <div className='w-full p-5 gap-5'>
                        ...
                        <div className='text-xl p-2 pb-8'>General information</div>
                        <div className='flex justify-between bg-customSlateBlue bg-opacity-70 rounded-md p-8 gap-5'>
                            <div className='flex gap-5'>
                                <div className=' bg-slate-600 bg-opacity-70  rounded-xl'>
                                    <Image
                                        className='w-44 h-44 rounded-full object-cover'
                                        src={profilepic}
                                        alt='profile' />
                                </div>
                                <div className='flex flex-col text-4xl front-bold gap-2'>
                                    <p>Folk</p>
                    ...
                    <footer className='flex justify-center items-center w-full text-white p-5'>
                        <div className='flex justify-start w-full bg-customSlateBlue bg-opacity-70 rounded-md '>
